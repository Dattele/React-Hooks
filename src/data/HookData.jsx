const HookData = [
  ...
  },
  {
    name: 'useDebugValue',
    description:
      'Allows you to add a label to a custom hook within React DevTools',
    syntax: 'useDebugValue(value, format?)',
    parameters: [
      {
        name: 'value',
        type: 'any',
        description: `The value you want displayed in React DevTools.`,
      },
      {
        name: 'format',
        type: 'function - optional',
        description: `A formatting function that takes the value and formats it into a more descriptive value.`,
      },
    ],
    returns: [],
    useCases: [
      'Debugging a custom hook',
      'Displaying custom hook state in a readable format.',
      'Making complex values easier to inspect.',
    ],
    exampleCode: `
      import { useDebugValue } from 'react';

      function checkOnlineStatus() {
        useDebugValue(userOnline ? 'Online' : 'Offline');
      }
      `,
    explanation: `The useDebugValue hook is used to help developers debug and understand their 
